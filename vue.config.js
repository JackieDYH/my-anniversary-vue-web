 ...
 * @LastEditTime: 2023-10-17 21:09:55
 * @LastEditors: Jackie
...
module.exports = defineConfig({
  ...
  // 公共路径配置错误：请确保在项目的 vue.config.js 文件中正确配置了公共路径。公共路径应该与你在 GitHub Pages 上托管项目的路径相对应。例如，如果你的项目托管在 https://jackiedyh.github.io/my-anniversary-vue/，则公共路径应设置为 '/my-anniversary-vue/'。
